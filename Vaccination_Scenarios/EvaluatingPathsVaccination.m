...
Vaccination = zeros(size(t_actual));
Vaccination(t_actual>=230) = 0.97*0.01*ones;
paramsOld.VaccinationRate = @(t)interp1(t_actual,Vaccination,t);
...
Vaccinates = zeros(length(t_actual),NSamples); 
NewCasesBootVac = zeros(length(t_actual),NSamples);
NewDeathsBootVac = zeros(length(t_actual),NSamples);
NewHospBootVac = zeros(length(t_actual),NSamples);
...
Beta = BETABoot(ll,:);
yinit2 = yinitB;
yb2 = zeros(length(t_actual),9*Number);
yb2(1,:) = yinitB;
...
xlim([t_span(220),t_span(end-3)])
h1=plot([t_span(230),t_span(230)],[0,2*max(median(NewCasesBoot(220:end-3,:)*N,2))],'k','LineWidth',1);
h1.Annotation.LegendInformation.IconDisplayStyle = 'off';
ylim([0,2*max(median(NewCasesBoot(220:end-3,:)*N,2))])
xtickformat('dd-MMM')
set(gcf,'Position',H)
set(gca,'FontSize',16,'FontName','Arial')
hold off
saveas(gcf,'InfectionsChicagoVac.fig');
print('-dpng','InfectionsChicagoVac');
...
ylabel('Number of Individuals')
xlim([t_span(220),t_span(end-3)])
h1=plot([t_span(230),t_span(230)],[0,1.3*max(median(NewDeathsBoot(220:end-3,:)*N,2))],'k','LineWidth',1);
h1.Annotation.LegendInformation.IconDisplayStyle = 'off';
ylim([0,1.3*max(median(NewDeathsBoot(220:end-3,:)*N,2))])
xtickformat('dd-MMM')
set(gcf,'Position',H)
set(gca,'FontSize',16,'FontName','Arial')
hold off
saveas(gcf,'DeathsChicagoVac.fig');
print('-dpng','DeathsChicagoVac');
...
ylabel('Number of Individuals')
xlim([t_span(220),t_span(end-3)])
h1=plot([t_span(230),t_span(230)],[0,1.3*max(median(NewHospBoot(220:end-3,:)*N,2))],'k','LineWidth',1);
h1.Annotation.LegendInformation.IconDisplayStyle = 'off';
ylim([0,1.3*max(median(NewHospBoot(220:end-3,:)*N,2))])
xtickformat('dd-MMM')
set(gcf,'Position',H)
set(gca,'FontSize',16,'FontName','Arial')
hold off
saveas(gcf,'HospChicagoVac.fig');
print('-dpng','HospChicagoVac');

disp(['Vaccinated: ',num2str(round([sum(median(N*Vaccinated(230:end-3,:),2)),sum(CI95Vac(1,230:end-3)),sum(CI95Vac(2,230:end-3))]))])

disp(['With Vaccination: ',num2str(round([sum(median(N*NewCasesBootVac(230:end-3,:),2)),sum(CI95NewCasesVac(1,230:end-3)),sum(CI95NewCasesVac(2,230:end-3))]))])
% disp(['Without Vaccination: ',num2str(round([sum(median(N*NewCasesBoot(230:end-3,:),2)),sum(CI95NewCases(1,230:end-3)),sum(CI95NewCases(2,230:end-3))]))])
disp(['Without Vaccination: ',num2str(round(sum(data1(230:end-3,1))))])

disp(['With Vaccination: ',num2str(round([sum(median(N*NewHospBootVac(230:end-3,:),2)),sum(CI95NewHospVac(1,230:end-3)),sum(CI95NewHospVac(2,230:end-3))]))])
% disp(['Without Vaccination: ',num2str(round([sum(median(N*NewHospBoot(230:end-3,:),2)),sum(CI95NewHosp(1,230:end-3)),sum(CI95NewHosp(2,230:end-3))]))])
disp(['Without Vaccination: ',num2str(round(sum(data1(230:end-3,3))))])

disp(['With Vaccination: ',num2str(round([sum(median(N*NewDeathsBootVac(230:end-3,:),2)),sum(CI95NewDeathsVac(1,230:end-3)),sum(CI95NewDeathsVac(2,230:end-3))]))])
% disp(['Without Vaccination: ',num2str(round([sum(median(N*NewDeathsBoot(230:end-3,:),2)),sum(CI95NewDeaths(1,230:end-3)),sum(CI95NewDeaths(2,230:end-3))]))])
disp(['Without Vaccination: ',num2str(round(sum(data1(230:end-3,2))))])